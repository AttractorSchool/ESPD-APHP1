                ...
                <div class="profile-body">
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-4 avatar-profile">
                            ...
                            <input type="file" name="avatar" class="form-control-file d-none" id="picturePreview"
                        ...
                        <div class="form-group">
                            <div class="interests-container">
                                @foreach ($user->interests as $interest)
                                    <input type="text" class="form-control" name="selected_interests[]"
                                           value="{{ $interest->name }}" readonly>
                                @endforeach
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <button class="btn-save btn" style="background-color: #804EEB; width: 100%">Сохранить данные
                        </button>
                    </form>
                </div>
            </div>
