...
{{--    --}}{{--    <div class="box">--}}
{{--    <div class="wrapper text-white" id="messages" style="height: 100%;" ></div>--}}
...
{{--                <label for="body" class="text-white">Текст сообщения</label>--}}
{{--                <input type="text" class="form-control text-white bg-secondary mb-4" id="body" name="body">--}}
{{--                <div id="error" class="alert alert-danger" style="display: none;"></div>--}}
{{--            </div>--}}
{{--            <div class="form-group mb-1 mt-4 col-3">--}}
{{--                <button type="submit" class="btn btn-primary m-0">Отправить</button>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </form>--}}
{{--</div>--}}
