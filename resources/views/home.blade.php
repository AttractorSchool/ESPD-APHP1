...
@section('content')
    ...
    <link href="{{ asset('css/media.css') }}" rel="stylesheet">
        <div class="row justify-content-center">
            <div class="promo" style="background-image: url('{{ asset('storage/pictures/Rectangle.png') }}');">
        ...
        <div class="event-calendar">
            <div class="event-info">
                <h2>Получи полный календарь мероприятий</h2>
                    ...
                    <div class="card my-2 text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Оставить заявку, чтобы мы ответили на все вопросы и рассказали о жизни
                                клуба</p>
                            <h5>Бесплатно</h5>
                            <a href="#" class="btn btn-warning rounded-5">Оставить заявку</a>
                        </div>
                    </div>
                @else
